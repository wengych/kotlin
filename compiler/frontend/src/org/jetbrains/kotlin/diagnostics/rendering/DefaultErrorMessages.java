...
public class DefaultErrorMessages {
    ...
    static {
        ...
        MAP.put(ENUM_USES_DEPRECATED_DELIMITERS, "Enum class ''{0}'' uses deprecated delimiter format, should be ENTRY1, ENTRY2, ..., ENTRY; members... ", NAME);
        MAP.put(ENUM_USES_DEPRECATED_CONSTRUCTORS, "Enum entry ''{0}'' uses deprecated constructor syntax, use ENTRY(arguments) instead", NAME);
