...
class DeprecatedEnumConstructorSyntaxFix(element: JetEnumEntry): JetIntentionAction<JetEnumEntry>(element) {
    ...
    override fun getText(): String = "Change to short enum constructor"

    override fun invoke(project: Project, editor: Editor?, file: JetFile?) = changeConstructorToShort(element)

    companion object: JetSingleIntentionActionFactory() {
        override fun createAction(diagnostic: Diagnostic): IntentionAction?  =
                diagnostic.createIntentionForFirstParentOfType(::DeprecatedEnumConstructorSyntaxFix)
        ...
        public fun createWholeProjectFixFactory(): JetSingleIntentionActionFactory = createIntentionFactory {
            JetWholeProjectForEachElementOfTypeFix.createByPredicate<JetEnumEntry>(
                    ...
                    familyName = "Change to short enum constructor"
            )
        }
