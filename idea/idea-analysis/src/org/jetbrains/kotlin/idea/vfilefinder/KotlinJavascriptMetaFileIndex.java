...
public final class KotlinJavascriptMetaFileIndex extends ScalarIndexExtension<FqName> {

    private static final Logger LOG = Logger.getInstance(KotlinJavascriptMetaFileIndex.class);
    private static final int VERSION = 1;
    public static final ID<FqName, Void> KEY = ID.create(KotlinJavascriptMetaFileIndex.class.getCanonicalName());
