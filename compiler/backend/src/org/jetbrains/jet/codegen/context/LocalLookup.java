    ...
    enum LocalLookupCase {
        VAR {
            ...
            public StackValue.StackValueWithSimpleReceiver innerValue(
                ...
                StackValue.Local thiz = StackValue.this0();
        ...
        LOCAL_NAMED_FUNCTION {
            ...
            public StackValue.StackValueWithSimpleReceiver innerValue(
                ...
                if (localFunClosure != null && JvmCodegenUtil.isConst(localFunClosure)) {
                    ...
                    return StackValue.field(localType, localType, JvmAbi.INSTANCE_FIELD, true, StackValue.this0());
                }

                String fieldName = "$" + vd.getName();
                StackValue.StackValueWithSimpleReceiver innerValue = StackValue.field(localType, classType, fieldName, false, StackValue.this0());
        ...
        RECEIVER {
            ...
            public StackValue.StackValueWithSimpleReceiver innerValue(
                ...
                StackValue.StackValueWithSimpleReceiver innerValue = StackValue.field(type, classType, CAPTURED_RECEIVER_FIELD, false, StackValue.this0());
